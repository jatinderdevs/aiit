...
<?php include_once('../../includes/header.php') ?>
    ...
    <section class="headersection">
        <div class="headerlayer">
            <div class="container">
                <h1 class="pageHeading">BSB80320 - graduate diploma of strategic leadership</h1>
            </div>
        </div>
    </section>
<div class="container">
        ...
        <div class="grid">
            ...
            <div class="highlight ">
                ...
                <h6> 
                    ...
                    <a href="../../assets/forms-and-policies/pre_enrolment/AIIT_45485_Pre-Enrol_FAQ_(BSB80320).pdf" target="_blank" class="  btn-link">click here</a></h6>
            </div>
            <div class="highlight ">
            ...
            <div class="col-md-12">
               ...
               <p>The handling of raw meat including beef, lamb, pork poultry, seafood and shellfish are part of the course requirements.
                ...
                <div class="coursebox">
                    <h4>Pathways</h4>
                    <p>
                    Graduates who complete this course may wish to undertake higher education qualifications in business, leadership, and management or seek advancement in the workforce in a notably strategic leadership role.
                    </p>
                </div>
                <div class="coursebox">
                    <h4>Units of Competency</h4>
                    <p>
                    Total number of units of competency - 8 (Total number of units - 2 core units and 6 elective units) Units of competency have been selected in accordance with the packaging rules and are relevant to the work outcome, local industry requirements and the AQF qualification level.
                    </p>
                    <br>
                <small><strong><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> Refer to: <a href=" https://training.gov.au/Training/Details/BSB80320" class="text-lowercase btn-link"> Refer to:  https://training.gov.au/Training/Details/BSB80320</a></strong></small>
                    <hr>
...
<script>
        ...
        async function getData() {
            ...
            const result=await fetch('<?php echo BASE_PATH; ?>data/bsb80320.json');
