...
<?php include_once('../../includes/header.php') ?>
    ...
    <section class="headersection">
        <div class="headerlayer">
            <div class="container">
                <h1 class="pageHeading">BSB50420 Diploma of leadership and management</h1>
            </div>
        </div>
    </section>
<div class="container">
        ...
        <div class="grid">
            ...
            <div class="highlight ">
                ...
                <h6> 
                    ...
                    <a href="../../assets/forms-and-policies/pre_enrolment/AIIT_45485_Pre-Enrol_FAQ_(BSB50420).pdf" target="_blank" class="  btn-link">click here</a></h6>
            </div>
            <div class="highlight ">
            ...
            <div class="col-md-12">
             ...
             <?php include_once('../../includes/entryRequirements.php') ?>
                ...
                <div class="coursebox">
                    <h4>Pathways</h4>
                    <p>
                    Potential employment options could include as a Manager in a range of industry areas and sectors. Students who complete this course may wish to continue their education into the BSB60420 Advanced Diploma of Leadership and Management or higher education qualifications in business and management
                    </p>
                </div>
                <div class="coursebox">
                    <h4>Units of Competency</h4>
                    <p>
                    Total number of units of competency - 12 (Total number of units - 6 core units and 6 elective units)
                    </p>
                    <br>
                <small><strong><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> Refer to: <a href="https://training.gov.au/Training/Details/BSB50420" class="text-lowercase btn-link"> Refer to: https://training.gov.au/Training/Details/BSB50420</a></strong></small>
                    <hr>
...
<script>
        ...
        async function getData() {
            ...
            const result=await fetch('<?php echo BASE_PATH; ?>data/bsb50420.json');
