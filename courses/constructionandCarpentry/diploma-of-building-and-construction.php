        ...
        <div class="grid">
            ...
            <div class="highlight ">
                ...
                <h6> 
                    ...
                    <a href="../../assets/forms-and-policies/pre_enrolment/AIIT_45485_Pre-Enrol FAQ (CPC50220).pdf" target="_blank" class="  btn-link">click here</a></h6>
            </div>
            <div class="highlight ">
        ...
        <div class="row reverse">
            <div class="col-md-8">
                ...
                <div class="coursebox">
                    <h4>Mode of Study</h4>
                    <p>
                        The program is classroom-based delivery face to face and in a simulated industry work environment with trainer led training in classrooms, workshops, and computer labs consisting of lectures, group discussions, workshops, and simulated or industry work environments. The student to trainer ratio is 1:20. Assessment consists of direct observation, product-based methods, portfolios, questioning and third-party evidence. To comply with the National Code of Practice for Providers of Education and Training to Overseas Students 2018, no more than one-third of the units of competency should be delivered online to international students.
                    </p>
                </div>
                <div class="coursebox">
                    <h4>Campuses</h4>
