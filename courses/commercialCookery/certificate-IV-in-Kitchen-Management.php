...
<?php include_once('../../includes/header.php') ?>
    ...
    <section class="headersection">
        <div class="headerlayer">
            <div class="container">
                <h1 class="pageHeading">SIT40521 Certificate IV in  kitchen management Packaged Pathway</h1>
            </div>
        </div>
    </section>
<div class="container">
        ...
        <div class="grid">
            ...
            <div class="highlight ">
                ...
                <h6> 
                    ...
                    <a href="../../assets/forms-and-policies/pre_enrolment/AIIT_45485_Pre-Enrol_FAQ_(SIT40521).pdf" target="_blank" class="  btn-link">click here</a></h6>
            </div>
            <div class="highlight ">
            ...
            <ul>
               ...
               <p>The handling of raw meat including beef, lamb, pork poultry, seafood and shellfish are part of the course requirements.
                ...
                <div class="coursebox">
                    ...
                    <br>
                <small><strong><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> Refer to: <a href="https://training.gov.au/Training/Details/SIT40521" class="text-lowercase btn-link"> Refer to: https://training.gov.au/Training/Details/SIT40521</a></strong></small>
                    <hr>
...
<script>
        ...
        async function getData() {
            ...
            const result=await fetch('<?php echo BASE_PATH; ?>data/sit40521.json');
            ...
            cellCode.innerHTML =`<strong>${ unit.unitCode}</strong>`;
