        ...
        <div class="grid">
            ...
            <div class="highlight ">
                ...
                <h6> 
                    ...
                    <a href="../../assets/forms-and-policies/pre_enrolment/AIIT_45485_Pre-Enrol_FAQ_(SIT60322).pdf" target="_blank" class="  btn-link">click here</a></h6>
            </div>
            <div class="highlight ">
...
<script>
        ...
        async function getData() {
            ...
            const result=await fetch('<?php echo BASE_PATH; ?>data/sit60322.json');
