        ...
        <div class="row">
            <div class="col-md-3">
                <div class="foottab ">
                    ...
                    <span class="">
                        ...
                        <br>
                        <a href="https://cricos.education.gov.au/Institution/InstitutionDetails.aspx?ProviderCode=03754M"
                            target="_blank"> CRICOS - 03754M</a><br>
                        <a href="https://abr.business.gov.au/ABN/View?id=24622575679" target="_blank">ABN - 24 622 575
                            679</a>
                    </span>
            ...
            <div class="col-md-3">
                <div class="foottab">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo BASE_PATH; ?>assets/forms-and-policies/AIIT_45485_Student_Handbook_RT.pdf"
                                target="_blank">Student Handbook</a>
                        </li>
                        <li>
            ...
            <div class="col-md-3">
                <div class="foottab">
                    ...
                    <a href="https://learner.wisenet.co/AII/CertificateValidation" target="_blank"
                        class="btn btn-sm btn-outline-light">Click here</a>
                </div>
            </div>
        </div>
        <div class="obriginal">
            ...
            <p>Australian International Institute of Technology acknowledges Aboriginal and Torres Strait Islander
                ...
                genders, sexualities, abilities and cultures.
            </p>
        </div>
...
<!-- Initialize Swiper -->
<script>
var swiper = new Swiper("#vertCarousal", {
    direction: "vertical",
    autoplay: {
        delay: 2500,
...
<script>
var swiper = new Swiper("#courseCard", {
    effect: "coverflow",
    grabCursor: true,
    centeredSlides: true,
    slidesPerView: "auto",
